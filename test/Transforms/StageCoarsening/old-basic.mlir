...
// CHECK-NEXT:     %[[CONSTRUCT_MEMORY_VIEW_0:.*]] = ktdp.construct_memory_view %[[CONSTANT_4]], sizes: [96, 64], strides: [64, 1] {coordinate_set = #[[$ATTR_0]], memory_space = "DDR"} : memref<96x64xf16, "DDR">
// CHECK-NEXT:     %[[CONSTRUCT_MEMORY_VIEW_1:.*]] = ktdp.construct_memory_view %[[CONSTANT_5]], sizes: [96, 64], strides: [64, 1] {coordinate_set = #[[$ATTR_0]], memory_space = "DDR"} : memref<96x64xf16, "DDR">
// CHECK-NEXT:     %[[CONSTRUCT_MEMORY_VIEW_2:.*]] = ktdp.construct_memory_view %[[CONSTANT_6]], sizes: [96, 64], strides: [64, 1] {coordinate_set = #[[$ATTR_0]], memory_space = "DDR"} : memref<96x64xf16, "DDR">
...
// CHECK-NEXT:                 ktdf.data_transfer from %[[PRIVATE_0]]#0{{\[}}%[[DIVSI_4]], %[[DIVSI_5]], %[[CONSTANT_0]]] size [1, 1, 64] to %[[PRIVATE_1]]#0{{\[}}%[[CONSTANT_0]]] size [64] : memref<1x1x64xf16, "L1">, memref<64xf16, "SFP_LRFREG">
...
// CHECK-NEXT:                 ktdf.data_transfer from %[[PRIVATE_0]]#1{{\[}}%[[DIVSI_6]], %[[DIVSI_7]], %[[CONSTANT_0]]] size [1, 1, 64] to %[[PRIVATE_1]]#1{{\[}}%[[CONSTANT_0]]] size [64] : memref<1x1x64xf16, "L1">, memref<64xf16, "SFP_LRFREG">
// CHECK-NEXT:               }
...
// CHECK-NEXT:                 ktdf.data_transfer from %[[PRIVATE_1]]#2{{\[}}%[[CONSTANT_0]]] size [64] to %[[PRIVATE_0]]#2{{\[}}%[[DIVSI_8]], %[[DIVSI_9]], %[[CONSTANT_0]]] size [1, 1, 64] : memref<64xf16, "SFP_LRFREG">, memref<1x1x64xf16, "L1">
// CHECK-NEXT:               }
// CHECK-NEXT:             }
// CHECK-NEXT:           } {loop_type = #ktdf.loop_type<parallel_loop>}
// CHECK-NEXT:         } {loop_type = #ktdf.loop_type<parallel_loop>}
